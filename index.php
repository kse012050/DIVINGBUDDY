...
<body>
    ...
    <section class="appArea" data-scroll>
        ...
        <p>Diving Buddy is a profile and feed-based matching app specifically designed for divers worldwide. <span></span> With just three easy steps on any mobile device before diving, individuals of all ages can easily find a dive buddy, making diving a lot more enjoyable while ensuring safety underwater.</p>
        <p>Explore the underwater world by connecting with divers around the globe through Diving Buddy.</p>
    </section>
